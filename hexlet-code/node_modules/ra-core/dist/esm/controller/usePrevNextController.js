...
export var usePrevNextController = function (props) {
    ...
    var isRecordIndexLastInNonLastPage = recordIndexInQueryData === ((_b = queryData === null || queryData === void 0 ? void 0 : queryData.data) === null || _b === void 0 ? void 0 : _b.length) - 1 &&
    ...
    var _j = useQuery([resource, 'getList', params], function () { return dataProvider.getList(resource, params); }, __assign({ enabled: !canUseCacheData }, otherQueryOptions)), data = _j.data, error = _j.error, isLoading = _j.isLoading;
