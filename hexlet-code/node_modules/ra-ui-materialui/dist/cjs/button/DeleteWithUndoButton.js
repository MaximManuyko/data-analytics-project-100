...
var DeleteWithUndoButton = function (props) {
    var _a = props.label, label = _a === void 0 ? 'ra.action.delete' : _a, className = props.className, _b = props.icon, icon = _b === void 0 ? defaultIcon : _b, onClick = props.onClick, _c = props.redirect, redirect = _c === void 0 ? 'list' : _c, mutationOptions = props.mutationOptions, _d = props.color, color = _d === void 0 ? 'error' : _d, rest = __rest(props, ["label", "className", "icon", "onClick", "redirect", "mutationOptions", "color"]);
    ...
    return (React.createElement(Button_1.Button, __assign({ onClick: handleDelete, disabled: isLoading, label: label, className: (0, clsx_1.default)('ra-delete-button', className), key: "button", color: color }, rest), icon));
};
