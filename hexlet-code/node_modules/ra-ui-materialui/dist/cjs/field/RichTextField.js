...
var RichTextFieldImpl = function (props) {
    ...
    var value = (_a = (0, get_1.default)(record, source)) === null || _a === void 0 ? void 0 : _a.toString();
...
RichTextFieldImpl.propTypes = __assign(__assign(__assign({}, Typography_1.default.propTypes), types_1.fieldPropTypes), { stripTags: prop_types_1.default.bool, purifyOptions: prop_types_1.default.any });
