...
var RadioButtonGroupInput = function (props) {
    ...
    var _g = (0, ra_core_1.useInput)(__assign({ format: format, onBlur: onBlur, onChange: onChange, parse: parse, resource: resource, source: source, validate: validate }, rest)), id = _g.id, isRequired = _g.isRequired, fieldState = _g.fieldState, field = _g.field, formState = _g.formState;
