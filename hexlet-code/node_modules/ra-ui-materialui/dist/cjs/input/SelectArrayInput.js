...
var SelectArrayInput = function (props) {
    ...
    var _j = (0, ra_core_1.useInput)(__assign({ format: format, onBlur: onBlur, onChange: onChange, parse: parse, resource: resource, source: source, validate: validate }, rest)), field = _j.field, isRequired = _j.isRequired, _k = _j.fieldState, error = _k.error, invalid = _k.invalid, isTouched = _k.isTouched, isSubmitted = _j.formState.isSubmitted, id = _j.id;
