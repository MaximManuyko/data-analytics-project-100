...
var SelectInput = function (props) {
    ...
    var _g = (0, ra_core_1.useInput)(__assign({ defaultValue: defaultValue, parse: parse, format: format, onBlur: onBlur, onChange: onChange, resource: resource, source: source, validate: validate }, rest)), field = _g.field, fieldState = _g.fieldState, id = _g.id, isRequired = _g.isRequired, isSubmitted = _g.formState.isSubmitted;
